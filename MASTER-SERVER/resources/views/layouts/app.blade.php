        ...
        <nav id="sidebar">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled components mb-5">
                    <li class="{{ strpos(Request::url(), 'home') ? 'active' : ''}}"><a href="{{url('/home')}}"><span class="fa fa-list mr-3"></span>Overview</a></li>
                    <li class="{{ strpos(Request::url(), 'tag') ? 'active' : ''}}"><a href="{{url('/tag')}}"><span class="fas fa-tag mr-3"></span>Tags</a></li>
                    ...
                    <!-- <li><a href="{{url('/tag')}}"><span class="fa fa-user mr-3"></span>Tags</a></li> -->
					<!--<li><a><span>&nbsp;</span></a></li>-->
