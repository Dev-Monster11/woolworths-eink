...
<head>
    ...
    <!-- landing css file link -->
    <link rel="stylesheet" href="{{asset('loading/css/style.css')}}">

    <link rel="stylesheet" href="{{asset('vendor1/css/bootstrap.min.css')}}"> <!-- Infamous bootstrap stylesheet -->
    <link rel="stylesheet" href="{{asset('vendor1/css/style-add.css')}}"> <!-- Main stylesheet -->
...
<body>
    <div class="wrapper d-flex align-items-stretch" id = 'ajax_body'>
        <nav id="sidebar">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled components mb-5">
                    ...
                    <li class="active"><a href="{{url('/tag')}}"><span class="fas fa-tag mr-3 fa-active"></span>Tags</a></li>
        ...
        <script>
            ...
            function ProcessNMAP(){
                $.ajax({
                    method: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                    },
                    url: "{{route('getXMLData')}}",
            ...
            function addconnect(){
                var ip_address = document.getElementById("dev_ip_address").innerText;
                window.location.replace("http://"+ip_address);
                setTimeout(function(){
